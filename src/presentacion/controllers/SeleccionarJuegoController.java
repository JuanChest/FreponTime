...
public class SeleccionarJuegoController {
    ...
    public void cerrarSesion(ActionEvent event) {
        ...
        NavegacionInterfaces.cambiarVentana((Stage) cerrarSesionButton.getScene().getWindow(),
    ...
    public void seleccionarBillar(ActionEvent event) { // 0 --> Billar, 1--> PingPong
        ...
        NavegacionInterfaces.cambiarVentana((Stage) billarButton.getScene().getWindow(),
                "/presentacion/views/HorarioJuegos.fxml", "Horarios Disponibles");
    }
    ...
    public void seleccionarPingPong(ActionEvent event) {
        ...
        NavegacionInterfaces.cambiarVentana((Stage) pingPongButton.getScene().getWindow(),
                "/presentacion/views/HorarioJuegos.fxml", "Horarios Disponibles");
    }
    ...
    public void pagarReserva(ActionEvent event) {
        ...
        NavegacionInterfaces.cambiarVentana((Stage) pagarReservaButton.getScene().getWindow(),
                "/presentacion/views/Pagar.fxml", "Pagos");
    }
